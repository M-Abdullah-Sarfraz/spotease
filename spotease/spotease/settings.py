"""
Django settings for spotease project.
...
SECRET_KEY = 'django-insecure-f%dd40ac_i$i4pg*++s2bn&wp3r4rqcr4^j-1v!_mh68^7-zy('
...
WSGI_APPLICATION = 'spotease.wsgi.application'
